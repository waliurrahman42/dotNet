...
namespace DbEntityFramework.Controllers
{
  //  [Authorize]
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseId,CourseName,Location,FacultyId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseId,CourseName,Location,FacultyId")] Course course)
        {
            if (ModelState.IsValid)
            {
